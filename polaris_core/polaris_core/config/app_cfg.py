# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in polaris-core.
...
import polaris_core
from polaris_core import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': polaris_core.model,
    'DBSession': polaris_core.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "0e873345-cde5-47c6-8625-49e5b502c237",
